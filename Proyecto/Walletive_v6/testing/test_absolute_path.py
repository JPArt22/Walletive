#!/usr/bin/env python3
"""
Test para verificar que la solución con ruta absoluta funcione
"""
...
def test_absolute_path():
    """Test para verificar que la solución con ruta absoluta funcione"""
    print("🧪 Test con ruta absoluta...")
    
    # Usar DatabaseManager con ruta por defecto (ahora absoluta)
    db = DatabaseManager()
    ...
    meta_id = db.crear_meta("🎯 Test Ruta Absoluta", 750.0, 8, "mensual")
    ...
    try:
        movement_logic.add(1, "Test Ingreso Absoluto", 200.0, 1, meta_id)
    ...
    try:
        meta_logic.update_goal(meta_id, "🎯 Test Ruta Absoluta Actualizado", 850.0)
    ...
    print("\n🎉 Test con ruta absoluta completado exitosamente!")
